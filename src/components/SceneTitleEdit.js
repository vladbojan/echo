...
const EDIT_SCENE_MUTATION = gql`
  mutation EditSceneMutation($id: ID!, $title: String!, $styling: String!, $media: String!, $position: String!) {
    updateScene(id: $id, title: $title, styling: $styling, media: $media, position: $position) {
      id
      title
      styling
      media
